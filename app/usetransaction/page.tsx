...
//     // Use functional form to get the new count
//     setCount((prev) => {
//       const newCount = prev + 1;
//       // Set userCount after delay using newCount
//       delay(3000).then(() => {
...
//           Current Count:{" "}
//           <span className="text-blue-600">{userCount && userCount}</span>
//         </p>
//       </div>
//     </div>
//   );
  ...
  return (
    <div className="mt-5 flex flex-col items-center max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex justify-between w-full mt-4">
        <p className="text-lg font-medium">
          User Count:{" "}
          <span className="text-green-600">{userCount && userCount}</span>
        </p>
      </div>
    </div>
  );
